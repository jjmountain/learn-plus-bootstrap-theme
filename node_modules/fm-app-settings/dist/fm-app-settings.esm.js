...
var script$2 = {
  ...
  watch: {
    settings: {
      deep: true,
      handler: function handler$$1(value) {
        this.setSettings();
      }
    }
  },
...
var script$3 = {
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () { return handler.upgradeElement(this$1.$el, 'mdk-drawer'); });
  },
  beforeDestroy: function beforeDestroy() {
    var this$1 = this;
...
export { Settings as FmAppSettingsBase, Drawer$1 as FmAppSettingsDrawer, Button as FmAppSettingsButton, Collapse as FmAppSettingsCollapse, toggle as FmToggleDirective, Session, listenOnRootMixin, sidebarProps, prefixProps };
